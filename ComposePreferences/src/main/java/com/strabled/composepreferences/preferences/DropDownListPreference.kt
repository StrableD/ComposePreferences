 ...
 * @param preference The [preference][androidx.datastore.preferences.core.Preference] object to manage the selected value.
...
fun <T: Any> DropDownListPreference(
    ...
    fun edit(value: T) {
        try {
            ...
            Log.e("DropDownListPreference", "Could not write preference $preference to database.", e)
        }
    }
